...
{
    public class RouletteRepository: BaseRepository<Entity.Roulette>, IRouletteRepository
    {        
        public RouletteRepository(IConnectionMultiplexer IConnectionMultiplexer)
